...
## 2026-07-21 - Fix Login Timing Attack
**Vulnerability:** User enumeration timing attack in Login handler due to early return on sql.ErrNoRows.
**Learning:** Bcrypt comparison is expensive, and skipping it when an email is not found allows attackers to easily guess valid emails by observing response times.
**Prevention:** Always perform a dummy bcrypt comparison using a structurally valid hash of the same cost factor when an email is not found.
